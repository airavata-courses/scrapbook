    ...
    ***************************************************************************** */
            ...
            return new Promise(function (resolve, reject) {
                if (_this.auth2.isSignedIn.get()) {
                    ...
                    if (loginStatusOptions && loginStatusOptions.refreshToken) {
                        _this.auth2.currentUser.get().reloadAuthResponse().then(function (authResponse) {
    ...
    var MicrosoftLoginProvider = /** @class */ (function (_super) {
                    ...
                    try {
                        var config = {
                            auth: {
                                ...
                                redirectUri: _this.initOptions.redirect_uri,
        ...
        MicrosoftLoginProvider.prototype.getLoginStatus = function () {
            var _this = this;
            return new Promise(function (resolve, reject) {
                var accounts = _this._instance.getAllAccounts();
                if (accounts.length > 0) {
                    try {
                        _this._instance.ssoSilent({
                            scopes: _this.initOptions.scopes,
                            loginHint: accounts[0].username
                        })
                            .then(function (loginResponse) {
                            _this.getSocialUser(loginResponse)
        ...
        MicrosoftLoginProvider.prototype.signOut = function (revoke) {
            ...
            return new Promise(function (resolve, reject) {
                try {
                    ...
                    _this._instance.logout({
                        account: accounts[0],
                        postLogoutRedirectUri: _this.initOptions.redirect_uri
                    })
                        .then(function () {
                        resolve();
                    })
